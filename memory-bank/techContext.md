...
## Future Stack (Not Implemented)

README mentions Python + FastAPI for heavier or batched workloads when Node/server actions are insufficient. No Python code exists in the repo today.

## Setup Documentation

1. `docs/SETUP.md` — Full local setup (Clerk, Supabase, Anthropic, Liveblocks)
2. `docs/SETUP_PAT.md` — GitHub PAT for pushing (if needed)
3. `docs/DATA_MODEL.md` — ERD links and schema slice overview
